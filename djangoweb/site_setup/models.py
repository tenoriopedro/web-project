...
class SiteSetup(models.Model):
    ...
    whatsapp_number = models.CharField(
        ...
        validators=[
            RegexValidator(
                regex=r'^\+?\d+$',
                message=(
                    'Digite apenas números, com ou sem +. Ex: +5521999999999')
    ...
    def save(self, *args, **kwargs):
        ...
        check_favicon(self.favicon, current_favicon_name)
...
class Banner(models.Model):
    ...
    description = models.CharField(
        max_length=250, default='', blank=True, verbose_name='Descrição'
    )
...
class Contacts(models.Model):
    ...
    telephone_number_bonsucesso = models.CharField(
        max_length=55,
        default='',
        verbose_name="Número Telefone Fixo(Bonsucesso)"
    )
    telephone_number_saocristovao = models.CharField(
        max_length=55, default='',
        verbose_name="Número Telefone Fixo(São Cristóvão)"
    )
    ...
    address_bonsucesso = models.CharField(
        max_length=155, default='', verbose_name="Endereço Bonsucesso"
    )
    address_bonsucesso_link = models.CharField(
        max_length=155, default='', verbose_name="Endereço Bonsucesso Link"
    )

    address_saocristovao = models.CharField(
        max_length=155, default='', verbose_name="Endereço São Cristóvão"
    )
    address_saocristovao_link = models.CharField(
        max_length=155, default='', verbose_name="Endereço São Cristóvão Link"
    )
